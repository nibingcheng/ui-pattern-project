...
// Add event listener to the input date (form)
...
startDate = new Date (`${year}`, `${month-1}`, `${day}`);  //second number is monthIndex, so 0 is January
...
function handleSubmit(e) {
  ...
  console.log(parsedInputDate[0], parsedInputDate[1], parsedInputDate[2]);
//   let nameMatch = false;
//   let index = null;
...
// if a CORS error is thrown, prepend this  https://cors-anywhere.herokuapp.com/